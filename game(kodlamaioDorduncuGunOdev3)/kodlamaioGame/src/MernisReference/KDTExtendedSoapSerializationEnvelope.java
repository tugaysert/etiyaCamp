...
public class KDTExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(KDTDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new KDTStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static KDTDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static KDTDateTimeConverter dateTimeConverter = new KDTStandardDateTimeConverter();

    public KDTExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public KDTExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new KDTMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=KDTHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,KDTExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=KDTHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
