...
public class KDTKPSPublicSoap
{
    ...
    public KDTKPSPublicSoap(){}

    public KDTKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public KDTKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        KDTExtendedSoapSerializationEnvelope envelope= new KDTExtendedSoapSerializationEnvelope(KDTExtendedSoapSerializationEnvelope.VER11);
