...
public class NPKExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(NPKDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new NPKStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static NPKDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static NPKDateTimeConverter dateTimeConverter = new NPKStandardDateTimeConverter();

    public NPKExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public NPKExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new NPKMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=NPKHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,NPKExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=NPKHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
