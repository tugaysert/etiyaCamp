...
public class URVExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(URVDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new URVStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static URVDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static URVDateTimeConverter dateTimeConverter = new URVStandardDateTimeConverter();

    public URVExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public URVExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new URVMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=URVHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,URVExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=URVHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
