...
public class URVKPSPublicSoap
{
    ...
    public URVKPSPublicSoap(){}

    public URVKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public URVKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        URVExtendedSoapSerializationEnvelope envelope= new URVExtendedSoapSerializationEnvelope(URVExtendedSoapSerializationEnvelope.VER11);
