...
public class NPKKPSPublicSoap
{
    ...
    public NPKKPSPublicSoap(){}

    public NPKKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public NPKKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        NPKExtendedSoapSerializationEnvelope envelope= new NPKExtendedSoapSerializationEnvelope(NPKExtendedSoapSerializationEnvelope.VER11);
